...
NRE #probability of equally distributed events 3.326 e-77
       
       
#for recurrent events 
RE = ((0.5 * 0.03)*((0.03*0.3)^29)*((0.3*0.122)^30)*((0.3*0.144)^30))
RE #probability of equally distributed events 6.577e-146

#more likely for non-recurrent events to be euqlaly distributed but both values are very low
